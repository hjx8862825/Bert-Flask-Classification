...
## Required parameters
flags.DEFINE_string(
    "data_dir", "C:\\workProgram\\PycharmProjects\\bert-programs\\same_dif",
    "The input data dir. Should contain the .tsv files (or other data files) "
    "for the task.")

flags.DEFINE_string(
    "bert_config_file", "C:\\workProgram\\PycharmProjects\\bert-programs\\chinese_L-12_H-768_A-12\\bert_config.json",
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string("task_name", "samedifprocessor", "The name of the task to train.")

flags.DEFINE_string("vocab_file", "C:\\workProgram\\PycharmProjects\\bert-programs\\chinese_L-12_H-768_A-12\\vocab.txt",
                    "The vocabulary file that the BERT model was trained on.")

flags.DEFINE_string(
    "output_dir", "C:\\workProgram\\PycharmProjects\\bert-programs\\same_dif_output",
    "The output directory where the model checkpoints will be written.")

## Other parameters

flags.DEFINE_string(
    "init_checkpoint", "C:\\workProgram\\PycharmProjects\\bert-programs\\chinese_L-12_H-768_A-12\\bert_model.ckpt",
...
class SameDifProcessor(DataProcessor):
    '''用于判断文章重复的dataProcessor'''
    def __init__(self):
        self.language = "zh"

    def get_train_examples(self, data_dir):
        file_path = os.path.join(data_dir, "train.tsv")# 文件路径
    ...
    def get_dev_examples(self, data_dir):
        '''获取开发集'''
        file_path = os.path.join(data_dir, "dev.tsv")  # 文件路径
        lines = self._read_tsv(file_path)
    ...
    def get_test_examples(self, data_dir):
        '''获取测试集'''
        file_path = os.path.join(data_dir, "test.tsv")  # 文件路径
        lines = self._read_tsv(file_path)
...
class MoveProcessor(DataProcessor):
  ...
  def get_train_examples(self, data_dir):
    ...
    return self._create_examples(
        self._read_tsv(os.path.join(data_dir, "train_sep2.csv")), "train")

  def get_dev_examples(self, data_dir):
    """See base class."""
    return self._create_examples(
        self._read_tsv(os.path.join(data_dir, "valid_sep2.csv")), "dev")
  ...
  def get_labels(self):
    """See base class."""
    return ["1029", "1030","1031","1032","1033","1034","1035","1036","1037"]
...
def main(_):
  ...
  processors = {
      "samedifprocessor": SameDifProcessor
  }
